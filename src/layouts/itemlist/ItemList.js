            ...
            <ul>
                {
                    list.map((elem, index) => {
                        return (
                            <li onClick={() => { openPlayer(elem) }} className={classes.pointerblock} ><div className={classes.list__listitem}>
                                <div>
                                    <img className={classes.list__img} src={elem.imgPath}></img>
                                </div>
                                <div className={classes.list__names}>
                                    <p className={classes.list__title}>{elem.title}</p>
                                    <p className={classes.list__authorname}>{elem.authorName}</p>
                                </div>
                                {/* <p className={classes.list__genre}>{elem.genre}</p> */}
                            </div></li>
                        )
                    })
                }
